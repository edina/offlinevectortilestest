 ...
 *
 * <p> server.NanoHTTPD version 1.24,
...
public class NanoHTTPD
{
    ...
    {
        System.out.println( "server.NanoHTTPD 1.24 (C) 2001,2005-2011 Jarno Elonen and (C) 2010 Konstantinos Togias\n" +
    ...
    private class HTTPSession implements Runnable
    {
        ...
        private String saveTmpFile(byte[] b, int offset, int len)
        {
            ...
            if (len > 0)
            {
                ...
                try {
                    File temp = File.createTempFile("server.NanoHTTPD", "", new File(tmpdir));
